...
save_images_and_labels(train_dataset, os.path.join(script_dir, "train_images_labels.csv"))
save_images_and_labels(test_dataset, os.path.join(script_dir, "test_images_labels.csv"))
